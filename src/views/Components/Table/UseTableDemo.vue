...
<template>
  <ContentWrap :title="`UseTable 操作`" style="margin-bottom: 20px">
    ...
    <BaseButton @click="selectAllNone">全不选</BaseButton>

    <BaseButton @click="delOrAddAction">添加操作列</BaseButton>

    <BaseButton @click="showOrHiddenStripe">隐藏斑马纹</BaseButton>
